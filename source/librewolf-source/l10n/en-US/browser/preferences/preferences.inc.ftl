...
# Sidebar
pane-librewolf-title = EloyBrowser
category-librewolf =
    .tooltiptext = about:config changes, logically grouped and easily accessible
# Main content
librewolf-header = EloyBrowser Preferences
...
content-blocking-section-top-level-description = EloyBrowser supports - and it enables by default - Enhanced Tracking Protection in Strict mode. This is one of the most important settings in the browser, as it provides state partitioning, strict blocking lists and other neat privacy features. We do not recommend changing to other modes.
